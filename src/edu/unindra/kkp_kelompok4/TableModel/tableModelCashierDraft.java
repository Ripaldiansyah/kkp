 ...
 * @author ripal
 */
public class tableModelCashierDraft extends AbstractTableModel{
	...
	private final String[] columnNames = {"No","Order Id","Tanggal Transaksi","Total Transaksi","Kasir","Nama Transaksi"};
	@Override
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch(columnIndex -1){
			...
			case 3 : return list.get(rowIndex).getEmployee().getEmployeeName();
			case 4 : return  list.get(rowIndex).getDraftName();

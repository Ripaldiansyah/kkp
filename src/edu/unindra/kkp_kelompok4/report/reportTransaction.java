 ...
 * @author ripal
 */
public class reportTransaction extends javax.swing.JPanel {
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                nameCashier = new javax.swing.JPanel();
                jLabel4 = new javax.swing.JLabel();
                listNameCashier = new javax.swing.JComboBox<>();
                totalShopping = new javax.swing.JPanel();
                ...
                titleLabel2.setText("Laporan Penjualan");
                ...
                listFilter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Filter laporan -", "Tampilkan semua", "Periode", "Metode Pembayaran", "Nama Kasir", "Total Belanja" }));
                ...
                titleLabel3.setText("Filter Transaksi");
                ...
                periodePanelLayout.setHorizontalGroup(
                        ...
                        .addGroup(periodePanelLayout.createSequentialGroup()
                                ...
                                .addGroup(periodePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(dateOrder2, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                ...
                paymentMethod.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Metode Pembayaran -", "CASH", "QRIS", "BANK TRANSFERT", "DEBIT", "OTHER" }));
                ...
                paymentMethodPanelLayout.setHorizontalGroup(
                        ...
                        .addGroup(paymentMethodPanelLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(paymentMethod, 0, 192, Short.MAX_VALUE)
                                .addContainerGap())
                );
                ...
                filter.add(paymentMethodPanel, "card2");

                jLabel4.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
                jLabel4.setText("Nama Kasir");

                listNameCashier.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Nama Kasir -" }));

                javax.swing.GroupLayout nameCashierLayout = new javax.swing.GroupLayout(nameCashier);
                nameCashier.setLayout(nameCashierLayout);
                nameCashierLayout.setHorizontalGroup(
                        nameCashierLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(nameCashierLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(nameCashierLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                nameCashierLayout.setVerticalGroup(
                        nameCashierLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(nameCashierLayout.createSequentialGroup()
                                .addGap(19, 19, 19)
                                .addComponent(jLabel4)
                ...
                javax.swing.GroupLayout totalShoppingLayout = new javax.swing.GroupLayout(totalShopping);
                totalShopping.setLayout(totalShoppingLayout);
                totalShoppingLayout.setHorizontalGroup(
                        totalShoppingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(totalShoppingLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(totalShoppingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                totalShoppingLayout.setVerticalGroup(
                        totalShoppingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(totalShoppingLayout.createSequentialGroup()
                                .addGap(19, 19, 19)
                                .addComponent(jLabel1)
                ...
                filter.add(totalShopping, "card2");
 ...
 private void panelDisplay(){
	...
	mainPanel.removeAll();
	mainPanel.add(new reportTransaction());
        mainPanel.repaint();
        ...
        private javax.swing.JPanel nameCashier;
        ...
        private javax.swing.JPanel totalShopping;
	...
	private void printReportAll(){
		...
		reportService.reportTransactionItem(panelViewReport);
	}
	...
	private void printReportPeriode(){
		...
		reportService.reportTransactionItemByPeriode(dateOrder1, dateOrder2, panelViewReport);
	}
	private void printReportPaymentMethod(){
		panelViewReport.removeAll();
		String payment = paymentMethod.getSelectedItem().toString();
		reportService.reportTransactionItemByPayment(payment,panelViewReport);
	}
	
	private void printReportCashier(){
		panelViewReport.removeAll();
		String cashier = listNameCashier.getSelectedItem().toString();
		reportService.reportTransactionItemByCashier(cashier,panelViewReport);
	}
	...
	private void printReportPrice(){
		...
		reportService.reportTransactionItemByTotalShoping(totalShoping1,totalShoping2,panelViewReport);
	}
	...
	private void reportItem(){
		...
		if (listFilter.getSelectedIndex()==0) {
			...
			enableButton();
			dataEmployee();
			nameCashier.setVisible(true);
		}else if (listFilter.getSelectedIndex()==5) {
			hideFilterItem();
			enableButton();
			totalShopping.setVisible(true);
		}
	}
	...
	private void hideFilterItem(){
		...
		nameCashier.setVisible(false);
		totalShopping.setVisible(false);
	}
	...
	private void dataEmployee(){
		List<modelEmployee> employeeList = servEmployee.getCarts();

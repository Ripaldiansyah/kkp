...
import edu.unindra.kkp_kelompok4.TableModel.tableModelCashier;
import edu.unindra.kkp_kelompok4.TableModel.tableModelDetailCashier;
 ...
 * @author ripal
 */
public class listTransaction extends javax.swing.JDialog {
	...
	private tableModelCashier tabelModel = new tableModelCashier();
	private tableModelDetailCashier tabelModelDetailCashier = new tableModelDetailCashier();
	public modelDetailCashier detailCashier = new modelDetailCashier();
	public modelCashier cashierModel = new modelCashier();
	public listTransaction(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
		...
		listTransaction.add(desktopPane);
		listTransaction.setSize(800, 600);
...
//		
	...
	@SuppressWarnings("unchecked")
		...
		String no = tableTransactionList.getModel().getValueAt(row, 1).toString();
		dispose();
		reportService.reportStruk(no);
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				listTransaction dialog = new listTransaction(new javax.swing.JFrame(), true);
...
private void loadData(){
	List<modelCashier>list = service.getItem();
	tabelModel.setData(list);
}
...
private void loadDataCart(){
	...
	String id = tableTransactionList.getValueAt(row, 1).toString();
		List <modelDetailCashier> list =servicedetailCashier.getItem(id);
...
private void dataChoose(){
	...
	private void editTransaction() {
		...
		List <modelCashierCart> listCart =  servicedetailCashier.getById(orderIdString);
